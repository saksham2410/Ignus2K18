      ...
      <View style={styles.tabsContainer}>
        <View style={styles.tabs}>
          <TouchableOpacity
            ...
            <Text style={liveHelpTextStyles}>Contact Us</Text>
          </TouchableOpacity>
  ...
  _renderLiveHelp() {
    return (
      <View style={styles.liveHelp}>
        <Text style={styles.liveHelpPhone}>Ignus Core Team</Text>
        <Text style={styles.liveHelpText}>
          All the team details will go here
        </Text>
        <RoundedButton
          text="Send Text Message (SMS)"
          onPress={() => Linking.openURL('sms:7073890734')}
          style={styles.liveHelpButton}
        />
        <RoundedButton
          text="Give Us A Call"
          onPress={() => Linking.openURL('tel:7073890734')}
          style={styles.liveHelpButton}
        />
      </View>
    );
